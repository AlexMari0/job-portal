          ...
          (searchFilter.title !== "" || searchFilter.location !== "") && (
            <>
              ...
              <div className="mb-4 text-gray-600 flex flex-wrap gap-2">
                {searchFilter.title && (
                  <span className="inline-flex items-center gap-2.5 bg-blue-50 border border-blue-200 px-4 py-1.5 rounded max-w-full">
                ...
                {searchFilter.location && (
                  <span className="inline-flex items-center gap-2.5 bg-red-50 border border-red-200 px-4 py-1.5 rounded max-w-full">
                    <span className="truncate max-w-[150px] sm:max-w-xs">
                      {searchFilter.location}
                    </span>
                    <img
